...
<@layout.registrationLayout displayInfo=social.displayInfo; section>
    ...
    <#elseif section = "form">
        <div>
            <img class="logo" src="${url.resourcesPath}/img/logo.jpg" alt="myLogo">
        </div>
        <div class="box-container">
            <div class="application-name-container">
                <p class="application-name">Welcome My Service!!</p>
            </div>
        <#if realm.password>
            <div>
        ...
        <#if social.providers??>
            <p class="para">${msg("Or Select Other Login Providers")}</p>
